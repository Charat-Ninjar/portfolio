  ...
  return (
    <div className="flex gap-10 pr-10">
      <a href="https://github.com/Charat-Ninjar" target="_blank" rel="..">
        <div className="flex items-center hover:text-glow rounded-full icon hover:scale-110">
          <img src="/github-light.svg" className="h-[38px] rounded-full"></img>
        </div>
      </a>
      <a href="https://www.linkedin.com/in/charat-p/" target="_blank" rel="..">
        <div className="flex items-center bg-white object-contain rounded-full icon hover:scale-110">
          <img
            src="/in1.png"
